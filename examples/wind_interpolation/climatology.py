...
def climatology(ds):
    ...
    np.savez(
        "../../datasets/climatology/climatology.npz", u=u_mean.values, v=v_mean.values
    )
...
def monthly_climatology(ds):
    ...
    np.savez(
        "../../datasets/climatology/monthly_climatology.npz",
        u=u_monthly_mean.values,
        v=v_monthly_mean.values,
    )
...
def weekly_climatology(ds):
    ...
    np.savez(
        "../../datasets/climatology/weekly_climatology.npz",
        u=u_weekly_mean.values,
        v=v_weekly_mean.values,
    )
