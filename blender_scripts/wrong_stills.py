...
import_color(bm, data_file = os.path.join(data_dir, "kernels", "s_wrong.csv"), palette_file = os.path.join(col_dir, "viridis.csv"))
...
vf_bm = import_vector_field(
    os.path.join(data_dir, "unwrap_sphere", f"frame_0.csv")
)
