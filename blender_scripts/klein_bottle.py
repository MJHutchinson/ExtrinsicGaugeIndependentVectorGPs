...
bpy.ops.object.empty_add(type='PLAIN_AXES', align='WORLD', location=klein_obj.location, scale=(1, 1, 1))
...
empty.rotation_euler = Euler((math.radians(30),math.radians(130),math.radians(90)), "YZX")
