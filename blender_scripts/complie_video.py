...
video_path = os.path.expanduser(
    "~/Documents/projects/ExtrinsicGaugeEquivariantVectorGPs/blender_outputs"
)
frame_path = os.path.expanduser(frame_path)
...
files = sorted(glob.glob(os.path.join(frame_path, "frame*.png")))
