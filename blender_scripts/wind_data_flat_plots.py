...
cc_bm = import_vector_field(os.path.join(data_dir, render_name, f"covariance_r2_flat.csv"))
...
set_object_collections(object=[earth_obj, vf_obj, mean_obj, line_obj,line_obj2, cc_obj])
