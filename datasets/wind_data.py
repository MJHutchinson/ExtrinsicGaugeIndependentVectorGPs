...
def get_winddata():
    url_u = "https://dataserv.ub.tum.de/s/m1524895/download?path=%2F5.625deg%2F10m_u_component_of_wind&files=10m_u_component_of_wind_5.625deg.zip"
    url_v = "https://dataserv.ub.tum.de/s/m1524895/download?path=%2F5.625deg%2F10m_v_component_of_wind&files=10m_v_component_of_wind_5.625deg.zip"
    ...
    target_dir = "data/global_wind_data"
    os.mkdir(target_dir)
